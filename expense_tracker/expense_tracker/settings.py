...
SECRET_KEY = 'django-insecure-6e1ryk7#lsbj7@fqg$dmucjxy!rb4wy^$-%&#s4)=c9qsnp2jd'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'expense_tracker/static_root')
...
EMAIL_HOST_PASSWORD = "wtwdfjkuxeexjiwp"
EMAIL_USE_TLS = True
EMAIL_PORT = 587
